...
Route::get('/dashboard/customer-list', [DashboardController::class, 'customerList'])->name('dashboard.customer');
Route::get('/dashboard/order-list', [DashboardController::class, 'orderList'])->name('dashboard.order');
Route::post('/dashboard/{id}/status/{status}/{product_id}', [DashboardController::class, 'orderStatus'])->name('order.status');
Route::get('/dashboard/billinginfo', [DashboardController::class, 'billingInfo'])->name('dashboard.billing');
